...
Original file is located at
    https://colab.research.google.com/drive/1LPKAELd4hGnZG5rLeXnlbEi7eZFzEAV1
"""
...
# Load image
img = cv2.imread('/content/images (1).jpeg', cv2.IMREAD_GRAYSCALE)
img2 = cv2.imread('/content/images (2).jpeg', cv2.IMREAD_GRAYSCALE)
